...
function Middle_sell() {
    ...
    function handleSubmit(e) {
        ...
        // Save multiple products in LocalStorage
            ...
            <div className="sell-box">
                ...
                <form onSubmit={handleSubmit} className="sell-form">
                    <div className="form-row"> 
                        ...
                        <input type="text" name="type" placeholder="Product Type" value={formData.type} onChange={handleChange} required />
                    </div>
