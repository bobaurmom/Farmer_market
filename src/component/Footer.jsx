    ...
    return(
        <>
         <div className="footer">
            ...
            <svg className="icon" onClick={() => navigate('/profile')} fill="#000000" height="800px" width="800px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
